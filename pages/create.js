...
export default function Create() {
  ...
  const [name, setName] = useState("Certification of Excellence"); // Property Address
  const [currentValuation, setCurrentValuation] = useState("No additional details"); // Property Address
        ...
        !address ? (
            ...
            <div className="form-group">
                ...
                <div className={styles.create__upload}>
                    ...
                    <div>
                        <label htmlFor="name"> Certification Details{" "}
                            <span className={styles.create__upload_required}>
                                (required)  
                            </span>
                        </label> {"  "}
                        <input id="name" type="text" placeholder="cert details"
                                value={name}
                                onChange={(e) => setName(e.target.value)}
                        />
                    </div>
                    <div>
                        <label htmlFor="currentValuation"> Additional comments{" "}
                        <span className={styles.create__upload_required}>
                        </span>
                        </label> {"  "}
                        <input id="currentValuation" type="text" placeholder="additional comments"
